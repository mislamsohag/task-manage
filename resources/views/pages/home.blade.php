    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header01">
                ...
                <div><a class="btn mt-3 bg-gradient-primary" href="{{url('/loginPage')}}">Login</a></div>
            </div>
        </div>
    </nav>
            ...
            <div class="container pt-2">
                <div class="row align-items-center mb-5">
                    <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                        <h2 class=" fw-bold mb-3">Elevate Your Task Manage with My Powerful Task Application! </h2>
                        <p class="lead text-muted mb-4">Discover streamlined transactions, real-time management, and actionable insights in one intuitive Task app.</p>
                        <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary me-2 mb-2 mb-sm-0" href="{{url('/registrationPage')}}">Registration</a>
                            <a class="btn bg-gradient-primary mb-2 mb-sm-0" href="{{url('/loginPage')}}">Login</a></div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                        <h2 class="fw-bold mb-5">Reach Out to Me: Let's Connect and Explore Opportunities Together</h2>
                        <h4 class="fw-bold">Address</h4>
                        <p class="text-muted mb-5">Dhaka, Bangladesh</p>
                        <h4 class="fw-bold">Contact Me</h4>
                        <p class="text-muted mb-1">mislamsoahg@gmail.com</p>
                        <p class="text-muted mb-0">+880 1812 060163</p>
                    </div>
                    <div class="col-12 col-lg-6 offset-lg-1">
                        <form action="#">
        ...
        <footer class="py-5 bg-light">
            ...
            <div class="mb-5"></div>
            <div class="container">
                <p class="text-center">All rights reserved &copy; SohagTech 2023- <?php echo date("Y"); ?>
